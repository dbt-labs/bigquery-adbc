...
// Python-models Dataproc + GCS support. Statement-level "execution mode"
// options let a caller submit python models (via Dataproc batch/job) and
// upload their sources to GCS.
